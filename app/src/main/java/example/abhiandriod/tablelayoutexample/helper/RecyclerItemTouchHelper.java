    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (viewHolder != null) {
            ...
            if (this.listener.getClass().getSimpleName().equals("JobApplicationsActivity")) {
                backgroundViewEdit = ((ApplicationAdapter.MyViewHolder) viewHolder).viewBackgroundEdit;
                backgroundViewDelete = ((ApplicationAdapter.MyViewHolder) viewHolder).viewBackgroundDelete;
                foregroundView = ((ApplicationAdapter.MyViewHolder) viewHolder).viewForeground;
            }
            //Selected item
